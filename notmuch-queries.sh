...
notmuch config set query.responsibilities 'to:pika-important or to:iso-broadcast or to:iso-help or (MIT and "W-2") or from:cfdurham@mit.edu or to:dename or to:yfncc or (from:anneh and not to:eecs-jobs-announce@csail.mit.edu) or from:lindasul'
notmuch config set query._P1 'not tag:todo and (from:megumiem@mit.edu or query:urgent or query:action or query:responsibilities)'

#begin_categories
notmuch config set query.P0 'query:mention and query:_P1'
notmuch config set query.P1 'query:_P1 and not query:P0'
notmuch config set query.P2 'not tag:todo and ((query:mention and not query:P1) or query:classes)'
...
notmuch config set query.random 'to:r-h-t or to:random-hall or to:roofdeck-eom or to:black-hole or to:black-hole-singularity or to:peckerites or to:clam-hole or to:let-me-in'
...
notmuch config set query.dormspam "tag:dormspam or (\" for bc-talk\" or to:mtg-announce or (to:exec and to:mit.edu) or to:peerears or to:pokemonmasters@mit.edu or to:wmbr-media@mit.edu or subject:audition or from:2017class@mit.edu or (subject:amphibious and subject:achievement) or to:firestorm@mit.edu or to:apo-pubdir or to:dynamit_chatter or to:ea-announce or to:mit-democrats-admin or to:2017class or to:aaa-announce or to:introtodeeplearning-staff or to:maslab-staff or to:mitai-announce or to:engineering-students or to:engineering-majors or to:all-undergrad or to:tbp-eligibles or to:hkn-eligibles or to:all-campus)"
